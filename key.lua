...
local Config = {
    ...
    ServiceId       = 27099, -- Your PlatoBoost Service ID
    PlatoSecret     = "88a4b830-5b93-459f-ad11-dc88c9a658bb", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/Hoboscipts/Regret/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    HubName         = "Regret Hub", -- The main title shown at the top of the GUI
    HubDescription  = "The BEST Arsenal Rage Hub" -- The text shown below the title
}
